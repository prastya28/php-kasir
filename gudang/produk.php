                ...
                <?php foreach ($produk as $key => $value) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal-danger" data-url="index.php?page=produk_hapus&id=<?= $value['id_produk']; ?>">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-muted">Apakah anda yakin ingin menghapus data produk ini? Data yang sudah terhapus tidak dapat dikembalikan.</div>
            </div>
