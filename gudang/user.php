                ...
                <?php foreach ($user as $key => $value) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal-danger" data-url="index.php?page=user_hapus&id=<?= $value['id_user']; ?>">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-muted">Apakah anda yakin ingin menghapus data pengguna ini? Data yang sudah terhapus tidak dapat dikembalikan.</div>
            </div>
